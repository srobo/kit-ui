...
window.addEventListener('DOMContentLoaded', event => {
  ...
  document.querySelectorAll('.sends-mutate-request')
    .forEach(el => el.addEventListener('change', function (e) {
...
const handlers = {
  'astoria/broadcast/usercode_log': contents => {
    ...
    if (contents.source === 'astoria') {
      contentEl.classList.add('has-text-weight-bold', 'has-text-centered', 'is-family-sans-serif')
